...
##                    of methods
##
##                    Note the calcQCmetrics.r script needs to be 
##                    have been run prior to this one
##
##                    The CellTypeQC.rmd script uses these metrics to output
##                    a html report
##
##                    This script is an adaptation of the one from brainFans/mouseArray
##
##---------------------------------------------------------------------#
...
## this version writes over the pass col to pass all samples 
...
QCSum$PassQC1 <- TRUE # keep all samples for data exploration purposes 
...
keepCols<-c("Individual_ID", "Study")
...
QCmetrics<-cbind(QCmetrics, closestCellTypePCA)
