---
title: "Dementia Mouse Methylation Array Project Quality Control within Cell Type"
author: "Emma Walker"
output: 
  html_document:
  toc: true
...
n.b. this version writes over the pass col to pass all samples for exploratory purposes
...
qcData <-paste0(projDir, "/2_normalised/QC/QCmetrics.rdata")
qcOutFolder<-paste0(projDir, "/2_normalised/QC")
#load(qcData)
...
load("2_normalised/QC/PCAAcrossAllCellTypes.rdata")
...
sample_anno<-QCmetrics[,c("Study", "Cell_Type")[c("Study","Cell_Type") %in% colnames(QCmetrics)]]
...
QCSum<-read.csv(paste0(projDir, "/2_normalised/QC/passQCStatusStage3AllSamples.csv"), row.names = 1)
